template = Template.create(job_id: 847455, title: "Super Cool Job Template", author: "borourke@crowdflower.com", summary: "This is a super cool job template for Brian Hazell", description: "This is a super cool job template.  It does super cool things.  Things so cool I'd be surprised if you have ever heard of them before.  You probably haven't, so let's just assume you're not as cool as this job template.", rating: 4)
...
template2 = Template.create(job_id: 847410, title: "Whatevs Kinda Template", author: "kirsten@crowdflower.com", summary: "This template is kinda whatevs if you ask me.", description: "This is a super cool job template.  It does super cool things.  Things so cool I'd be surprised if you have ever heard of them before.  You probably haven't, so let's just assume you're not as cool as this job template.", rating: 3)
